INSERT INTO user_app (username, name, password, role) VALUES ('lmarquez', 'luis márquez', '$2a$10$ywh1O2EwghHmFIMGeHgsx.9lMw5IXpg4jafeFS.Oi6nFv0181gHli', 'ROLE_CUSTOMER');
INSERT INTO user_app (username, name, password, role) VALUES ('fperez', 'fulano pérez', '$2a$10$V29z7/qC9wpHfzRMxGOHye5RMAxCid2/MzJalk0dsiA3zZ9CJfub.', 'ROLE_ASSISTANT_ADMINISTRATOR');
INSERT INTO user_app (username, name, password, role) VALUES ('mhernandez', 'mengano hernández', '$2a$10$TMbMuEZ8utU5iq8MOoxpmOc6QWQuYuwgx1xJF8lSMNkKP3hIrwYFG', 'ROLE_ADMINISTRATOR');
